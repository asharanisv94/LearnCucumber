...
public class Project__1 {
    ...
    public Project__1 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Project__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Project__1) == false) {
            return false;
        }
        Project__1 rhs = ((Project__1) other);
